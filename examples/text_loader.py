...
class text_loader():
    def __init__(self):
        ...
        self.data = {}
        self.load_JSON()
        self.__init_check_state()
        pass
    
    def __init_check_state(self):
        if self.case_name=="陆火联合.json":
            self.check_state_candidate = self.check_state_candidate_2024
        elif self.case_name=="对海打击红方.json":
            self.check_state_candidate = self.check_state_candidate_2025_red
        elif self.case_name=="对海打击蓝方.json":
            self.check_state_candidate = self.check_state_candidate_2025_blue
        else:
